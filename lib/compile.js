...
var translate = (function () {
  ...
  function data(node, options, resume) {
    visit(node.elts[0], options, function (err, val) {
      ...
      if (typeof val !== "string" && ((typeof val === "undefined" ? "undefined" : _typeof(val)) !== "object" || !val)) {
  ...
  function root(node, options, resume) {
    visit(node.elts[1], options, function (err1, val1) {
      if (val1.constructor === Object || val1.constructor === Array) {
        //anything else can be used
